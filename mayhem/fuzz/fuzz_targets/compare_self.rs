...
fuzz_target!(|data: &[u8]| {
    ...
    let nfd_utf16 = nfd.normalize_utf16(&utf16).into_owned();
    ...
    let nfc_utf16 = nfc.normalize_utf16(&utf16).into_owned();
    ...
    let nfkd_utf16 = nfkd.normalize_utf16(&utf16).into_owned();
    ...
    let nfkc_utf16 = nfkc.normalize_utf16(&utf16).into_owned();
